        ...
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<GoldData>() {
                    ...
                    public void onNext(@NonNull GoldData goldData) {
                        ...
                        TextView data=(TextView) view.findViewById(R.id.ounceSilver);
                        TextView dataGr=(TextView) view.findViewById(R.id.gramSilver);
                        ...
                        changeNum=goldData.items.get(0).chgXag;
                        data.setText(String.valueOf(goldData.items.get(0).xagPrice)+" USD");
                        dataGr.setText(String.valueOf(calc.OZ_to_GR(goldData.items.get(0).xagPrice))+" USD");
                        if (changeNum>0){
                        ...
                        if (prefs.getBoolean("switch_chang_load",true)){
                            Picasso.with(getContext())
                                    .load("https://goldprice.org/charts/silver-price-performance-USD_x.png")
                                    .into(stat);
                        }
